...
ConVar hl2_walkspeed( "hl2_walkspeed", "270" );
ConVar hl2_normspeed( "hl2_normspeed", "270" );
ConVar hl2_sprintspeed( "hl2_sprintspeed", "360" );

ConVar hl2_darkness_flashlight_factor ( "hl2_darkness_flashlight_factor", "1" );

#ifdef HL2MP
	#define	HL2_WALK_SPEED 270
	#define	HL2_NORM_SPEED 270
	#define	HL2_SPRINT_SPEED 360
#else
...
#ifdef HL2MP
	CSuitPowerDevice SuitDeviceSprint( bits_SUIT_DEVICE_SPRINT, 5.0f );				// 100 units in 4 seconds
#else
